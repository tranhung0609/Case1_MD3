...
>>>>>>> 61d91d7871f9378df4f7d05140be670673378e6d
                                </div>
                                <p class="bottom-area d-flex px-3">
                                    <a href="cart.jsp" class="add-to-cart text-center py-2 mr-1"><span>Add to cart <i class="ion-ios-add ml-1"></i></span></a>
                                    <a href="product-single.jsp" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>
                                </p>
                            </div>
                        </div>
                    </div>
...
<%--        <div class="collapse navbar-collapse" id="ftco-nav">--%>
<%--            <ul class="navbar-nav ml-auto">--%>
<%--                <li class="nav-item"><a href="/homepage/minishop-master/minishop-master/homepage.jsp" class="nav-link">Home</a>--%>
<%--                </li>--%>
<%--                <li class="nav-item dropdown active">--%>
...
<%--                    </div>--%>
<%--                </li>--%>
<%--                <li class="nav-item"><a href="/homepage/minishop-master/minishop-master/about.jsp" class="nav-link">About</a>--%>
<%--                </li>--%>
<%--                <li class="nav-item"><a href="/homepage/minishop-master/minishop-master/blog.jsp" class="nav-link">Blog</a></li>--%>
<%--                <li class="nav-item"><a href="/homepage/minishop-master/minishop-master/contact.jsp" class="nav-link">Contact</a>--%>
<%--                </li>--%>
<%--                <li class="nav-item"><a href="/createproduct/create-product.jsp" class="nav-link">Create Product</a>--%>
<%--                </li>--%>
<%--                <li class="nav-item cta cta-colored"><a href="/homepage/minishop-master/minishop-master/cart.jsp" class="nav-link"><span class="icon-shopping_cart"></span>[0]</a>--%>
<%--                </li>--%>
...
<%--        <div class="row no-gutters slider-text align-items-center justify-content-center">--%>
<%--            <div class="col-md-9 ftco-animate text-center">--%>
<%--                &lt;%&ndash;                <p class="breadcrumbs"><span class="mr-2"><a href="homepage.jsp">Home</a></span> <span>Shop</span></p>&ndash;%&gt;--%>
...
<%--                        <div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">--%>
<%--                            <div class="product d-flex flex-column">--%>
<%--                                <a href="" class="img-prod"><img class="img-fluid" src="${product.image}"--%>
...
<%--                                               aria-expanded="true" aria-controls="collapseOne">Men's--%>
<%--                                            </a>--%>
<%--                                        </h4>--%>
<%--                                    </div>--%>
...
<%--                                               href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Women's--%>
<%--                                            </a>--%>
<%--                                        </h4>--%>
<%--                                    </div>--%>
...
<%--                                        <h4 class="panel-title">--%>
<%--                                            <a class="collapsed" data-toggle="collapse" data-parent="#accordion"--%>
<%--                                               href="#collapseFour" aria-expanded="false" aria-controls="collapseThree">Clothing--%>
<%--                                            </a>--%>
<%--                                        </h4>--%>
<%--                                    </div>--%>
