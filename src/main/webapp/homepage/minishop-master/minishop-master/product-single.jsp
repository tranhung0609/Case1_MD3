    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs"><span class="mr-2"><a href="homepage.jsp">Home</a></span> <span>Shop</span></p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <p><a href="cart.jsp" class="btn btn-black py-3 px-5 mr-2">Add to Cart</a><a href="cart.jsp" class="btn btn-primary py-3 px-5">Buy now</a></p>
            </div>
        </div>
